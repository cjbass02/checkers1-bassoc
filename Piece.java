...
public class Piece {
    ...
    private void repositionCrown() {
        crownEllipse.setLayoutX(x* BoardController.SQUARE_SIZE + BoardController.SQUARE_SIZE/2);
        crownEllipse.setLayoutY((y* BoardController.SQUARE_SIZE + BoardController.SQUARE_SIZE/2) - 10);
    }
    ...
    public void setActive(boolean isActive) {
        if(isActive) {
            ...
            if(crownEllipse != null) {
                crownEllipse.setStrokeWidth(3);
            }

        } else {
            ellipse.setStrokeWidth(1);
            if(crownEllipse != null) {
                crownEllipse.setStrokeWidth(1);
            }
        }
    }
    ...
    private void move(Square square) {
        ...
        if(type.equals(Type.BLACK) && y == 0 && !isKing) {
            this.isKing = true;
            crownEllipse = createEllipse();
            repositionCrown();
            crownEllipse.toFront();
    ...
    public boolean isValidOrdinaryMove(Square square) {
        if(type.equals(Type.BLACK)) {
            if(!isKing) {
                ...
                return ((square.getY() == y - 1) || (square.getY() == y + 1) &&
                        Math.abs(square.getX()-x) == 1);
            }
